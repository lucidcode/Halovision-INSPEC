...
clusterCores = [["APSS Cortex-A32 0", "APSS Cortex-A32 1"]]
coreNames_cortexM0PLUS = ["Secure Enclave Cortex-M0+"]
coreNames_cortexA32 = ["APSS Cortex-A32 0", "APSS Cortex-A32 1"]
...
class DtslScript(ConfigurationBaseSDF):
    ...
    def getOptionList():
        return [
            DTSLv1.tabSet("options", "Options", childOptions=
                ...
                +[DTSLv1.tabPage("SMP_Cluster0", "Cortex-A32", childOptions=[
                    DTSLv1.enumOption('traceCapture', 'Trace capture method', defaultValue="none",
                    ...
                    DTSLv1.booleanOption('coreTrace', 'Enable Cortex-A32 core trace', defaultValue=False,
                        childOptions = [
                            DTSLv1.booleanOption('SMP_Cluster0_0', 'Enable APSS Cortex-A32 0 trace', defaultValue=True),
                            DTSLv1.booleanOption('SMP_Cluster0_1', 'Enable APSS Cortex-A32 1 trace', defaultValue=True),
                            DTSLv1.booleanOption('timestamp', "Enable ETM Timestamps", description="Controls the output of timestamps into the ETM output streams", defaultValue=True),
                ...
                +[DTSLv1.tabPage("sync", "CTI Synchronization", childOptions=[
                    ...
                    DTSLv1.booleanOption(coreNames_cortexA32[1], coreNames_cortexA32[1], description="Add core to synchronization group", defaultValue=False, isDynamic=True),
    ...
    def setInitialOptions(self):
        ...
        traceModeSet = {self.getOptionValue("options.SMP_Cluster0.traceCapture"), self.getOptionValue("options.cortexM55.traceCapture")}
