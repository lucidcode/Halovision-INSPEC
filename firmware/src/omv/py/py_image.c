...
STATIC MP_DEFINE_CONST_FUN_OBJ_KW(py_image_difference2_obj, 2, py_image_difference2);
...
static const mp_rom_map_elem_t locals_dict_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_difference2),          MP_ROM_PTR(&py_image_difference2_obj)},
    ...
    {MP_ROM_QSTR(MP_QSTR_difference2),          MP_ROM_PTR(&py_func_unavailable_obj)},
